...
<p class="list-group-item" style="font-weight:bold;">  Aplikacja webowa umożliwiająca:</p>
<li class="list-group-item"> Rejestracje wraz z logowaniem użytkownika </li>
<li class="list-group-item"> Przeglądanie dostępnych książek</li>
<li class="list-group-item"> Przeglądanie wypożyczonych książek</li>
<li class="list-group-item"> Wypożyczać książki</li>
<li class="list-group-item"> Zwracać książki</li>
<li class="list-group-item"> Edytować profil wraz ze zmianą hasła</li>
</ul>
