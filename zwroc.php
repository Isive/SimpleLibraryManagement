...
if (isset($_POST['zwroc'])) {
    ...
    if (count($errors) == 0) {
        ...
        $query = "DELETE FROM wypozyczenia WHERE id_ksiazki = '".$_POST['id']."' AND id_uzytkownika = '".$_SESSION['id']."'    ";
        mysqli_query($db, $query);
        array_push($errors, "Książka została zwrócona");
    }
...
<tr><td colspan="2">Zwracanie książki</td></tr>
<tr><td style="width:60%;">Podaj ID książki:</td><td><input style="background-color: rgba(20, 52, 157, 0.8);width:40%;color: white;"min="0" type="number" name="id"></td></tr>
<tr><td colspan="2"><input type="submit" class="myButton" style="width:100%" value="Zwróć" name = "zwroc"></td></tr>
